...
export default function Home() {
  ...
  async function fetchCSVData() {
    // Change url to the one of your choice.
    const csvUrl =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ_SPSfqcF3AcCJmmmzVLxbbBvInozEe_RR3l4qd583d4jTDPgWteK4qQOPW2ddGfC-2BjGZsx2rjKf/pub?output=csv";
